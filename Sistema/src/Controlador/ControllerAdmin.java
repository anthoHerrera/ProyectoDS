...
public class ControllerAdmin {
    ...
    public ArrayList<Articulo> consultaArticulos(String comando) throws SQLException {
    ...
    public void agregaArticulo(List<String> atributos, String id) throws SQLException {
        PreparedStatement statement = cnx.getCnx().prepareStatement("INSERT INTO articulo(idarticulo, nombre, descripcion, marca, precio, "
